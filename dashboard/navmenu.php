<div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="https://github.com/dvpbwxwx" target="_blank" rel="noopener noreferrer" style="font-size:13pt"><img src="../assets/images/logo.png" width="80px" alt="" srcset=""><strong>TSM</strong></a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           if ($users['status'] == 1) {
               ...
               echo ""; // Tidak ada output untuk status 2
           } else {
               echo ""; // Tidak ada output untuk status lainnya
           }
             ?>
